      ...
      <header className="border-b border-gray-200 sticky top-0 z-50 bg-white">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button onClick={() => { const el = document.getElementById('about'); if (el) window.scrollTo({ top: el.offsetTop - 80, behavior: 'smooth' }); }} className="text-sm font-medium text-gray-700 hover:text-amber-700 transition-colors">회사소개</button>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 shadow-lg">
            <button onClick={() => { setMenuOpen(false); const el = document.getElementById('about'); if (el) window.scrollTo({ top: el.offsetTop - 80, behavior: 'smooth' }); }} className="block w-full text-left px-6 py-3 text-sm text-gray-700 hover:bg-gray-50">회사소개</button>
