...
import { fetchProductByCode, getImageUrl, getFallbackImageUrl, formatPrice, calcCardPrice, Product } from '@/lib/supabase';
...
function ProductDetail() {
  ...
  const showPrice = searchParams.get('price') === 'on';
